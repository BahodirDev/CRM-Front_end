...
function Basket(props) {
  ...
  useEffect(() => {
    fetch('https://crmstore.herokuapp.com/getAllProducts')
      .then(data => data.json())
      .then(res => {
        console.log(res);
  ...
  function Cost() {
    fetch("https://crmstore.herokuapp.com/cost",{
    headers:{
  ...
  function removeOrder(id) {
    fetch("https://crmstore.herokuapp.com/removeorder/" + id, {
      method: "DELETE"
    })
      .then(data => data.json())
      .then(res => {
                    ...
                    <tr className='tr_box' key={idx} style={{background:'red'}}>
                      ...
                      <td className='tr'>
                        <input type="number" className="form-control" id="floatingPassword" defaultValue={val.amount} onChange={e => {
                          ...
                          fetch('https://crmstore.herokuapp.com/editamount', {
                            method: "put",
                            headers: {
                      ...
                      <td className='tr'>
                        <input type="number" className="form-control" id="floatingPassword" defaultValue={val.sale_price} onChange={e => {
                          fetch('https://crmstore.herokuapp.com/editprice', {
                            method: "put",
                            headers: {
                              "Content-Type": 'application/json'
                            },
