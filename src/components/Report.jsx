...
function Report(props) {
    ...
    useEffect(() => {
        ...
        fetch('https://crmstore.herokuapp.com/getHistory')
            .then(data => data.json())
            .then(res => {
        ...
        fetch('https://crmstore.herokuapp.com/allList')
            .then(data => data.json())
            .then(res => {
    ...
    function filterReport(e) {
        ...
        fetch(`https://crmstore.herokuapp.com/getQuery`, {
            method: "POST",
            headers: {
    ...
    const generelReport = () => {
        fetch(`https://crmstore.herokuapp.com/getQueryReport`, {
            method: "POST",
            headers: {
                "Content-Type": 'application/json'
            },
    ...
    const remove = (id) => {
        fetch('https://crmstore.herokuapp.com/removeReport/' + id, {
            headers:{
                Authorization:JSON.parse(localStorage.getItem('jwt'))
            },
            method: "DELETE"
